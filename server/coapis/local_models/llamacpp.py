...
from coapis.constant import DEFAULT_LOCAL_PROVIDER_DIR
...
class LlamaCppBackend:
    """
    CoApis local model backend for managing llama.cpp server installation
    and setup.
    """
    ...
    def start_download(
        ...
        spec = ProcessDownloadTaskSpec(
            process_name=f"coapis-llamacpp-download-{staging_dir.name}",
            command=["coapis-llamacpp-download", download_url],
