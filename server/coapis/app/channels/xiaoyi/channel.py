...
class XiaoYiChannel(BaseChannel):
    ...
    async def start(self) -> None:
        ...
        async with _active_connections_lock:
            ...
            if (
                ...
                # NOTE: _render_style sync removed (v0.8.2) —
                # filtering is handled centrally by workspace.py RenderStyle
    ...
    async def _handle_a2a_request(self, message: Dict[str, Any]) -> None:
        ...
        try:
            ...
            allowed, error_msg = self._check_allowlist(session_id, False)
            if not allowed:
                logger.info(
                    "xiaoyi allowlist blocked: sender=%s",
                    session_id,
                )
                return
    ...
    def _extract_xiaoyi_parts(
        ...
        # NOTE: filter_thinking removed (v0.8.2) — workspace.py RenderStyle handles filtering
        ...
        # NOTE: channel-level tool_messages filtering removed (v0.8.2) —
        # filtering handled centrally by workspace.py RenderStyle
