...
"""
MatrixChannel: CoApis BaseChannel implementation for Matrix (via matrix-nio).
...
logger = logging.getLogger("coapis.channels.matrix")
...
# Known CoApis slash commands — used to decide whether to strip
# @mention prefix
...
class MatrixChannelConfig:
    ...
    def __init__(self, raw: dict[str, Any]) -> None:
        ...
        self.device_name: str = raw.get("device_name", "coapis-worker")
...
class MatrixChannel(BaseChannel):
    """CoApis channel that connects to a Matrix homeserver via matrix-nio."""
    ...
    async def _on_room_event(
        ...
        # Skip history prepend for slash commands — CoApis's command parser
    ...
    def build_agent_request_from_native(self, native_payload: Any) -> Any:
        ...
        # in the same room share one session (CoApis keys session state on
