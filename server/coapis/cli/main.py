...
@click.group(
    ...
    lazy_subcommands={
        "acp": ("coapis.cli.acp_cmd", "acp_cmd", ".acp_cmd"),
        "app": ("coapis.cli.app_cmd", "app_cmd", ".app_cmd"),
        "channels": (
            "coapis.cli.channels_cmd",
            "channels_group",
            ".channels_cmd",
        ),
        "channel": (
        ...
        "daemon": ("coapis.cli.daemon_cmd", "daemon_group", ".daemon_cmd"),
        "chats": ("coapis.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "chat": ("coapis.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "clean": ("coapis.cli.clean_cmd", "clean_cmd", ".clean_cmd"),
        "cron": ("coapis.cli.cron_cmd", "cron_group", ".cron_cmd"),
        "env": ("coapis.cli.env_cmd", "env_group", ".env_cmd"),
        "init": ("coapis.cli.init_cmd", "init_cmd", ".init_cmd"),
        "models": (
            "coapis.cli.providers_cmd",
            "models_group",
            ".providers_cmd",
        ),
        "skills": ("coapis.cli.skills_cmd", "skills_group", ".skills_cmd"),
        "uninstall": (
            "coapis.cli.uninstall_cmd",
            "uninstall_cmd",
            ".uninstall_cmd",
        ),
        "desktop": ("coapis.cli.desktop_cmd", "desktop_cmd", ".desktop_cmd"),
        "update": ("coapis.cli.update_cmd", "update_cmd", ".update_cmd"),
        "shutdown": (
            "coapis.cli.shutdown_cmd",
            "shutdown_cmd",
            ".shutdown_cmd",
        ),
        "auth": ("coapis.cli.auth_cmd", "auth_group", ".auth_cmd"),
        "agents": ("coapis.cli.agents_cmd", "agents_group", ".agents_cmd"),
        "agent": ("coapis.cli.agents_cmd", "agents_group", ".agents_cmd"),
        "plugin": (
            "coapis.cli.plugin_commands",
            "plugin",
            ".plugin_commands",
        ),
