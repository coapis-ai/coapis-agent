...
"""CLI command: run CoApis app on a free port in a native webview window."""
...
def desktop_cmd(
    ...
    """Run CoApis app on an auto-selected free port in a webview window.
    ...
    window without conflicting with an existing CoApis app instance.
    """
    ...
    click.echo(f"Starting CoApis app on {url} (port {port})")
