...
"""Extensible hooks for `coapis doctor`
(entry points + programmatic registration).

Plugins can expose a setuptools entry point in group ``coapis.doctor``::

    [project.entry-points."coapis.doctor"]
