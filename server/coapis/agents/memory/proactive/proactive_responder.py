...
async def send_proactive_message_via_http(
    ...
    """Send a proactive message by directly calling the CoApis API."""
    ...
    try:
        ...
        logger.error(
            "Timeout (%ds) calling CoApis API for proactive message",
            timeout_seconds,
        )
    except Exception as e:
        logger.error("Error calling CoApis API for proactive message: %s", e)
